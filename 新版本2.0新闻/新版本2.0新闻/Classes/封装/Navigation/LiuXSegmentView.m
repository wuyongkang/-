...
-(void)initData{
    ...
    if (_titles.count<MAX_TitleNumInWindow+1) {
        _btn_w=self.bounds.size.width/_titles.count;
    }else{
        _btn_w=self.bounds.size.width/MAX_TitleNumInWindow;
    }
...
-(void)btnClick:(UIButton *)btn{
    ...
    CGFloat maxOffsetX= _bgScrollView.contentSize.width-self.bounds.size.width;
